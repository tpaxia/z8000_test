...
TESTS = [
    ...
    TestCase(
        ...
        tags=["bit", "word", "R_mode"],
        issues=["Z8002 sets S flag, Z8001 does not; BIT should only affect Z"],
    ...
    TestCase(
        ...
        tags=["bit", "word", "R_mode"],
        issues=["Z8002 sets Z flag, Z8001 does not; RES should not affect flags"],
        code=[0xA300],
        regs={0: 0x0000},
    ...
    TestCase(
        ...
        tags=["bit", "word", "R_mode"],
        issues=["Z8002 sets S flag, Z8001 does not; RES should not affect flags"],
